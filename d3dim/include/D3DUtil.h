...
//-----------------------------------------------------------------------------
    ...
    #define DEBUG_MSG(str)    			printf("[%s:%i](%s) %s\n", (char*)__FILE__, (DWORD)__LINE__, (char*)__func__, str);
    #define DEBUG_MSG1(str, arg1)		printf("[%s:%i](%s) ", (char*)__FILE__, (DWORD)__LINE__, (char*)__func__, str, arg1); \
										printf(str, arg1); printf("\n");
    #define DEBUG_MSG2(str, arg1, arg2)	printf("[%s:%i](%s) ", (char*)__FILE__, (DWORD)__LINE__, (char*)__func__, str, arg1, arg2); \
										printf(str, arg1, arg2); printf("\n");
#else
...
#if defined(DEBUG) | defined(_DEBUG)
    #define DEBUG_MSG(str)    			printf("[%s:%i](%s) %s\n", (char*)__FILE__, (DWORD)__LINE__, (char*)__func__, str);
    #define DEBUG_MSG1(str, arg1)		printf("[%s:%i](%s) %s\n", (char*)__FILE__, (DWORD)__LINE__, (char*)__func__, str, arg1);
    #define DEBUG_MSG2(str, arg1, arg2)	printf("[%s:%i](%s) %s\n", (char*)__FILE__, (DWORD)__LINE__, (char*)__func__, str, arg1, arg2);
#else
    #define DEBUG_MSG(str)    (0L)
#endif
*/
