...
HRESULT App_InitDeviceObjects( LPDIRECT3DDEVICE7 pd3dDevice )
{
    ...
    g_pddsTexture1 = CreateTexture( pd3dDevice, (char*)"tree1.bmp" );
    g_pddsTexture2 = CreateTexture( pd3dDevice, (char*)"tex1.bmp" );
    g_pddsTexture3 = CreateTexture( pd3dDevice, (char*)"earth.bmp" );
