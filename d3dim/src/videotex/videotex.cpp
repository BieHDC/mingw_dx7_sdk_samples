...
CMyD3DApplication::CMyD3DApplication()
                  :CD3DApplication()
{
	m_strWindowTitle  = TEXT((char*)"VideoTex: Textures with an AVI file");
...
HRESULT CMyD3DApplication::OneTimeSceneInit()
{
    ...
    D3DTextr_CreateEmptyTexture( (char*)"VideoTexture", 128, 128, 0,
...
HRESULT CMyD3DApplication::InitDeviceObjects()
{
    ...
    m_pd3dDevice->SetTexture( 0, D3DTextr_GetSurface((char*)"VideoTexture") );
...
HRESULT CMyD3DApplication::UpdateTexture()
{
    ...
    LPDIRECTDRAWSURFACE7 pddsTexture = D3DTextr_GetSurface((char*)"VideoTexture");
    if( NULL == pddsTexture )
        return E_FAIL;
