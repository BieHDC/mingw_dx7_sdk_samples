...
CMyD3DApplication::CMyD3DApplication()
                  :CD3DApplication()
{
    m_strWindowTitle  = TEXT( (char*)"Bend: Surface Skinning Example" );
...
HRESULT CMyD3DApplication::OneTimeSceneInit()
{
    ...
    // Create textures
    D3DTextr_CreateTextureFromFile( (char*)"Banana.bmp" );
...
HRESULT CMyD3DApplication::FrameMove( FLOAT fTimeKey )
{
	...
	D3DVECTOR tmp = vEyePt + vView;
    D3DUtil_SetViewMatrix( matView, tmp, vLookatPt, vUpVec );
...
HRESULT CMyD3DApplication::InitDeviceObjects()
{
    ...
    m_pd3dDevice->SetTexture( 0, D3DTextr_GetSurface((char*)"Banana.bmp") );
                            ...
                            WORD** ppIndices, DWORD* pdwNumIndices )
{
    ...
    D3DVECTOR tmp = -vPoint;
    D3DVECTOR tmp2 = -vNormal;
    InitBlendVertex( pVertices[dwNumVertices-1], tmp, 1.0f, tmp2, 0.0f, 0.0f );
