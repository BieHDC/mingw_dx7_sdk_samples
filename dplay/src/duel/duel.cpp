...
int WINAPI WinMain( HINSTANCE hInstance, HINSTANCE, LPSTR, int )
{
    ...
    ReadRegKey( g_hDuelKey, (char*)"Player Name", 
                g_strLocalPlayerName, MAX_PLAYER_NAME, (char*)"" );
    ReadRegKey( g_hDuelKey, (char*)"Session Name", 
                g_strSessionName, MAX_SESSION_NAME, (char*)"" );
    ReadRegKey( g_hDuelKey, (char*)"Preferred Provider", 
    ...
    WriteRegKey( g_hDuelKey, (char*)"Player Name", g_strLocalPlayerName );
    WriteRegKey( g_hDuelKey, (char*)"Session Name", g_strSessionName );
    WriteRegKey( g_hDuelKey, (char*)"Preferred Provider", g_strPreferredProvider );
