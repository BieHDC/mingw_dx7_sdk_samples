...
#define SAFE_DELETE_ARRAYT(p,q) { if(p) { delete[] (q);   (p)=NULL; } }
                      ...
                      INT nCmdShow )
{
    ...
    ReadRegKey( g_hDPlaySampleRegKey, (char*)"Player Name", 
                g_strLocalPlayerName, MAX_PLAYER_NAME, (char*)"" );
    ReadRegKey( g_hDPlaySampleRegKey, (char*)"Session Name", 
                g_strSessionName, MAX_SESSION_NAME, (char*)"" );
    ReadRegKey( g_hDPlaySampleRegKey, (char*)"Preferred Provider", 
                g_strPreferredProvider, MAX_SESSION_NAME, (char*)"" );
    ...
    if( SUCCEEDED( hr ) )
    {
        ...
        WriteRegKey( g_hDPlaySampleRegKey, (char*)"Player Name", g_strLocalPlayerName );
        WriteRegKey( g_hDPlaySampleRegKey, (char*)"Session Name", g_strSessionName );
        WriteRegKey( g_hDPlaySampleRegKey, (char*)"Preferred Provider", g_strPreferredProvider );
    }
...
HRESULT ProcessDirectPlayMessages( HWND hDlg )
{
    ...
    while( TRUE )
    {
        ...
        if( hr == DPERR_BUFFERTOOSMALL )
        {
            ...
            SAFE_DELETE_ARRAYT( pvMsgBuffer, (BYTE(*)[])pvMsgBuffer );
