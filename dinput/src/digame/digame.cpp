...
HRESULT CreateDInput( HWND hWnd )
{
    ...
    {
        DisplayError( (char*)"DirectInputCreate() failed." );
        return E_FAIL;
    }
                           ...
                           const DIDATAFORMAT* pdidDataFormat, DWORD dwFlags )
{
    ...
    {
        DisplayError( (char*)"CreateDeviceEx() failed" );
        return E_FAIL;
    }
    ...
    {
        DisplayError( (char*)"SetDataFormat() failed" );
        return E_FAIL;
    }
    ...
    {
        DisplayError( (char*)"SetCooperativeLevel() failed" );
        return E_FAIL;
    }
