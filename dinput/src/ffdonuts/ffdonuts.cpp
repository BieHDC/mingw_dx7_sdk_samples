...
HRESULT InitializeGame( HWND hWnd )
{
    ...
    if( FAILED(hr) )
    {
        CleanupAndDisplayError((char*)"DirectDrawCreate Failed!");
        return E_FAIL;
    }
    ...
    if( FAILED(hr) )
    {
        CleanupAndDisplayError((char*)"SetCooperativeLevel Failed");
        return E_FAIL;
    }
    ...
    if( FAILED(hr) )
    {
        CleanupAndDisplayError((char*)"SetDisplayMode Failed!");
        return E_FAIL;
    }
    ...
    if( FAILED(hr) )
    {
        CleanupAndDisplayError((char*)"CreateSurface FrontBuffer Failed!");
        return E_FAIL;
    }
    ...
    if( FAILED(hr) )
    {
        CleanupAndDisplayError((char*)"GetAttachedSurface Failed!");
        return E_FAIL;
    }
    ...
    if( FAILED(hr) )
    {
        CleanupAndDisplayError((char*)"Could not create surfaces!");
        return E_FAIL;
    }

    if( FAILED( RestoreSurfaces() ) )
    {
        CleanupAndDisplayError((char*)"RestoreSurfaces Failed!");
        return E_FAIL;
    }
...
HRESULT RestoreSurfaces()
{
    ...
    {
        CleanupAndDisplayError((char*)"Could not load palettes");
        return E_FAIL;
    }
    ...
    if( NULL == hbm )
    {
        CleanupAndDisplayError((char*)"Could not load bitmap");
        return E_FAIL;
    }
    ...
    if( FAILED(hr) )
    {
        CleanupAndDisplayError((char*)"Could not copy bitmaps to surfaces");
        DeleteObject( hbm );
        return E_FAIL;
    }
