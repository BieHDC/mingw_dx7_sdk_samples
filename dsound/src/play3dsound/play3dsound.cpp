...
VOID LoadWaveFile( HWND hDlg, TCHAR* strFileName )
{
    ...
    {        
        SetStatusUI( hDlg, TEXT((char*)"Couldn't create sound buffer.") );
        SetFileUI( hDlg, TEXT((char*)"") );
    }
    ...
    if( hr == S_OK )
    {
        ...
        {       
            SetStatusUI( hDlg, TEXT((char*)"File loaded using hardware mixing.") );
        }
        else
        {
            SetStatusUI( hDlg, TEXT((char*)"File loaded using software mixing.") );
        }
    }
}
...
HRESULT CreateStaticBuffer( HWND hDlg, TCHAR* strFileName )
{
    ...
    {
        SetStatusUI( hDlg, TEXT((char*)"Bad wave file.") );
        SetFileUI( hDlg, TEXT((char*)"") );
        return S_FALSE;
    }
    ...
    case -1: // User canceled dialog box
        SetStatusUI( hDlg, TEXT((char*)"Load aborted.") );
        SetFileUI( hDlg, TEXT((char*)"") );
        return S_FALSE;
