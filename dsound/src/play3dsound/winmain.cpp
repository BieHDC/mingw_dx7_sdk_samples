...
VOID OnInitDialog( HWND hDlg )
{
    ...
    SetStatusUI( hDlg, TEXT((char*)"No file loaded.") );
...
VOID OnOpenSoundFile( HWND hDlg ) 
{
    ...
    SetStatusUI( hDlg, TEXT((char*)"Loading file...") );
...
HRESULT OnPlaySound( HWND hDlg ) 
{
    ...
    SetStatusUI( hDlg, TEXT((char*)"Sound playing.") );
...
VOID OnStopSound( HWND hDlg ) 
{
    ...
    SetStatusUI( hDlg, TEXT((char*)"Sound stopped.") );
}
